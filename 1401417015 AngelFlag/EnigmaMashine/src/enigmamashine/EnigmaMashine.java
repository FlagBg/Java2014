...
public class EnigmaMashine {
    ...
    int bestNumberOfDictionaryHits = 0;
    String bestDecryptedString = "";
    char bestInnerRotorSetting =' ';
    char bestMiddleRotorSetting =' ';
    char bestOuterRotorSetting = ' ';
    
   
    public static void main(String[] args) throws IOException {
        // create an instance of this class
        EnigmaMashine EnigmaInstance = new EnigmaMashine();        
   ...
   public void encodeText()
	...
	{
		int numberOfWordsFound =  1;		// tracks how many words found in dictionary for each possible string
    ...
    {
        String newString = "";
        for (String wordsArray1 : wordsArray) {
            newString = newString + wordsArray1 + " ";
        }    	
    ...
    {	    
        ...
        for (String wordsArray1 : wordsArray) {
            ...
            if (wordExists(wordsArray1.toLowerCase()) && (wordsArray1.length() > 0)) {
                wordFoundCount++;
                // For debugging:
    ...
    public void readInDictionaryWords() throws IOException
    {
        ...
        File dictionaryFile = new File("C:\\Users\\THE NET\\Documents\\GitHub\\Java2014\\1401417015 AngelFlag\\EnigmaMashine\\Dictionary.txt");
        // declare the file
        // print the directory where this program expects to find dictionary
        System.out.println(System.getProperty("C:\\Users\\THE NET\\Documents\\GitHub\\Java2014\\1401417015 AngelFlag\\EnigmaMashine"));
    ...
    public boolean wordExists( String wordToLookup)
    {
        if( dictionary.contains( wordToLookup)) {
            return true;    // words was found in dictionary1
        }
        else {
