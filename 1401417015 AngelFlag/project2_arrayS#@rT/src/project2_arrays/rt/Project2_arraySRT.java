...
public class Project2_arraySRT {
    ...
    //int[] array = new int[50];//tova mi e za dvata masiva!
        ...
        public static String autoTowns(){
            ...
            String[] towns = {"Пловдив", "Бургас", "Боровец", "Варна","София", "Велико Търново",
            "Стара Загора", "Ивайловград", "Крумовград","Долен Чифлик", "Хасково", "Долно Калугерово", 
            "Разград", "Пещера","Плевен", "Русе","Монтана", "Силистра", "Сливен", "Смолян", 
            "Търговище", "Шумен","Ямбол", "Благоевград", "Видин", "Враца", "Габрово", 
            "Добрич", "Кърджали","Кюстендил", "Ловеч",  "Пазарджик", 
            "Перник", "Албена", "Златни пясъци", "Константин и Елена", 
            "Лозенец", "Царево", "Слънчев бряг","Пампорово", "Каварна", "Несебър", 
            "Ахтопол", "Черноморец", "Китен", "Карлово","Асеновград", 
            "Сопот", "Калофер", "Харманли", "Градешница", "Пловидв" };
            br++;
            return towns[br];
